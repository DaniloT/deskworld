...
Dependendo do método de iluminação, vários filtros diferentes devem ser aplicados, como explicado em~[\citenum{muller}]. Na iluminação híbrida, deve-se aplicar todos os filtros correspondentes as duas iluminações para obter a melhor imagem possível. Assim, os filtros a serem aplicados são apresentados na Figura~[\ref{filtros}]. São eles:
