...
Dependendo do método de iluminação, vários filtros diferentes devem ser aplicados, como explicado em~[\citenum{muller}], de forma a se excluir interferências e separar somente os toques. A biblioteca \textit{Community Core Vision}, utilizada neste trabalho, possui vários filtros, que estão detalhados, bem como sua utilização, no capítulo~[\ref{cap4.6}].
