...
{
	b2Body* other;			///"..rovides quick access to the other body attached.
	b2Contact* contact;		///"..he contact
	b2ContactEdge* prev;	///"..he previous contact edge in the body's contact list
	b2ContactEdge* next;	///"..he next contact edge in the body's contact list
};
