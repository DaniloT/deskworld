...
Para capturar a imagem a ser processada de modo a identificar os toques sobre a superfície, foi utilizada uma câmera \textit{PlayStation Eye}, que pode ser observada na Figura~\ref{ps3eyenosuporte}. A escolha foi baseada no baixo custo da câmera, sua alta resolução para sua faixa de preço, ângulo de abertura, pois permite a captura de imagens da superfície inteira com apenas uma câmera, e a alta taxa de frames por segundo. Sua resolução pode ser configurada em 640 x 480 \textit{pixels}, ou em 320 x 240 \textit{pixels} numa taxa de atualização de 75 ou 120 frames por segundo, respectivamente.
